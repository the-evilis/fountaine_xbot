    ...
    try:
        ...
        try:
            ...
            try:
                ...
                if len(worksheets) > 1:
                    faq_sheet = worksheets[1]
                    logger.info(f"Using worksheet: {faq_sheet.title}")
...
TEXTS = {
    "ru": {
        ...
        "level_unknown": "Не знаю / Пройти тест",
        ...
        "faq_a1": "Стандартный урок — 60 минут. Также есть интенсивные форматы по 90 минут.",
        "faq_q2": "Какой минимальный уровень?",
        "faq_a2": "Принимаем с любым уровнем, включая нулевой (A1). Перед началом — тестирование.",
        "faq_q3": "Есть ли скидки?",
        "faq_a3": "Да! При оплате 4+ уроков — скидка 10%, при 8+ уроках — скидка 15%.",
        "faq_q4": "Как проходят занятия?",
        "faq_a4": "Занятия проходят онлайн через Zoom. Нужен только интернет и микрофон.",
        ...
        "price_2": "Пакет 4 урока — 1 800 сом (–10%)",
        "price_3": "Пакет 8 уроков — 3 400 сом (–15%)",
        "price_4": "🎁 Пробный урок — БЕСПЛАТНО",
        "record_now": "🎫 Записаться",

        "contacts_title": "📌 Контакты:",
        "contact_phone": "📞 Телефон: +996 700 123 456",
        "contact_email": "✉️ Email: info@fountaine.kg",
        "contact_instagram": "Instagram: @fountaine.ai",
        "contact_location": "📍 Бишкек, ул. Чуй 123",
    ...
    "ky": {
        ...
        "level_intermediate": "🎯 Intermediate (B1)",
        "level_upper": "🔥 Upper-Intermediate (B2)",
        "level_unknown": "Билбейм / Тест тапшыруу",
        ...
        "faq_a1": "Стандарттык сабак — 60 мүнөт. Интенсивдүү формат — 90 мүнөт.",
        "faq_q2": "Минималдык деңгээл кандай?",
        "faq_a2": "Нөлдөн баштап (A1) кабыл алабыз. Башында тестирлөөдөн өтөсүз.",
        "faq_q3": "Арзандатуулар барбы?",
        "faq_a3": "Ооба! 4+ сабак — 10% арзандатуу, 8+ сабак — 15% арзандатуу.",
        "faq_q4": "Сабактар кандай өтөт?",
        "faq_a4": "Zoom аркылуу онлайнда өтөт. Интернет жана микрофон гана керек.",
        ...
        "price_2": "4 сабак пакети — 1 800 сом (–10%)",
        "price_3": "8 сабак пакети — 3 400 сом (–15%)",
        ...
        "contact_email": "✉️ Email: info@fountaine.kg",
        "contact_instagram": "Instagram: @fountaine.ai",
        "contact_location": "📍 Бишкек, Чуй көчөсү 123",
