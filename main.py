...
TEXTS = {
    "ru": {
        ...
        "review_1": "✨ 3 айда абдан чоң жетишкендиктерге ээ болдум. Мугалимдер — мыкты! — Айжан",
        "review_2": "✨ Гибкое расписание, адекватные цены. Советую всем! — Бакыт",
        "review_3": "✨ Лучшая школа в городе. Очень внимательный подход. — Василиса",
    ...
    "ky": {
        ...
        "review_1": "✨ 3 айда абдан чоң жетишкендиктерге ээ болдум. Мугалимдер — мыкты! — Айжан",
        "review_2": "✨ Ыңгайлуу расписание, жеткиликтүү баалар. Сунуштайм! — Бакыт",
        "review_3": "✨ Шаардагы эң жакшы мектеп. Мугалимдер өтө кунт коюшат. — Василиса",
